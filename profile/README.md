...
| Plain Typst Book (`plain_typst_book`)                 | typst | [plain_typst_book](https://github.com/myst-templates/plain_typst_book)                 | [![](https://github.com/myst-templates/plain_typst_book/actions/workflows/jtex.yml/badge.svg)](https://github.com/myst-templates/plain_typst_book/actions/workflows/jtex.yml)                 |
| Letterloom Typst Template (`letterloom-typst`)        | typst | [letterloom-typst](https://github.com/stefanv/myst-typst-letterloom)                   | [![](https://github.com/stefanv/myst-typst-letterloom/actions/workflows/jtex.yml/badge.svg)](https://github.com/stefanv/myst-typst-letterloom/actions/workflows/jtex.yml)                     |
...
| Optica journals template (`optica_journals`)          | tex   | [optica_journals](https://github.com/ssenhorst/optica_journals)                        | [![](https://github.com/ssenhorst/optica_journals/actions/workflows/jtex.yml/badge.svg)](https://github.com/ssenhorst/optica_journals/actions/workflows/jtex.yml)                             |
